...
<body class="d-flex flex-column h-100">
  ...
  <main role="main" class="mb-2">
    ...
    <div class="container mt-2">
      ...
      <h1 class="tieu-de">Quản lý Sửa Truyện tranh</h1>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col">
          <h3 class="text-truyen-tranh">Sửa Truyện Tranh</h3>
        </div>
      </div>
      <div class="row">
        <div class="col">
            ...
            <div class="form-row">
              <div class="form-group col">
                ...
                <div class="preview-img-container text-center">
                  <img src="/project-nentang/assets/uploads/truyen-tranh/<?= $truyenRow['truyen_hinhdaidien'] ?>" id="preview-img" width="200px" />
                </div>
