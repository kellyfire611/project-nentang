...
<body class="d-flex flex-column h-100">
  ...
  <main role="main" class="mb-2">
    ...
    <div class="container mt-2">
      ...
      <h1 class="tieu-de">Quản lý Sửa Tập Truyện tranh</h1>
    </div>
          ...
          <form name="frmThemMoi" id="frmThemMoi" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-9">
                ...
                <input type="text" class="form-control" id="chuong_ten" name="chuong_ten" placeholder="Tên tập truyện tranh" value="<?= $chuongRow['chuong_ten'] ?>">
              </div>
            </div>
