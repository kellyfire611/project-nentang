...
<body class="d-flex flex-column h-100">
  ...
  <main role="main" class="mb-2">
    ...
    <div class="container mt-2">
      ...
      <h1 class="tieu-de">Quản lý Thêm mới Tiểu thuyết</h1>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col">
          <h3 class="text-tieu-thuyet">Thêm mới Tiểu Thuyết</h3>
        </div>
      </div>
      <div class="row">
        <div class="col">
          ...
          <form name="frmThemMoi" id="frmThemMoi" method="post" action="" enctype="multipart/form-data">
            <div class="form-row">
              <div class="form-group col">
                ...
                <input type="text" class="form-control" id="truyen_ma" name="truyen_ma" placeholder="Mã tiểu thuyết" value="">
              </div>
              <div class="form-group col">
                <label for="truyen_ten">Tên tiểu thuyết</label>
                <input type="text" class="form-control" id="truyen_ten" name="truyen_ten" placeholder="Tên tiểu thuyết" value="">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group">
                <label for="truyen_loai">Loại tiểu thuyết</label>
                <input type="text" class="form-control" id="truyen_loai" name="truyen_loai" placeholder="Loại tiểu thuyết" value="#1-Tiểu thuyết" readonly>
              </div>
              <div class="form-group col">
                <label for="truyen_theloai">Thể loại tiểu thuyết</label>
                <input type="text" class="form-control" id="truyen_theloai" name="truyen_theloai" placeholder="Thể loại tiểu thuyết">
              </div>
              <div class="form-group col">
                <label for="truyen_tacgia">Tác giả tiểu thuyết</label>
                <input type="text" class="form-control" id="truyen_tacgia" name="truyen_tacgia" placeholder="Tác giả tiểu thuyết">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col">
              ...
              <div class="form-group col">
                ...
                <textarea class="form-control" id="truyen_mota_ngan" name="truyen_mota_ngan" placeholder="Mô tả ngắn về tiểu thuyết" rows="10"></textarea>
              </div>
            </div>
