...
<body class="d-flex flex-column h-100">
  ...
  <main role="main" class="mb-2">
    ...
    <div class="container mt-2">
      ...
      <h1 class="tieu-de">Quản lý Sửa Tiểu thuyết</h1>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col">
          <h3 class="text-tieu-thuyet">Sửa Tiểu thuyết</h3>
        </div>
      </div>
      <div class="row">
        <div class="col">
          ...
          <form name="frmThemMoi" id="frmThemMoi" method="post" action="" enctype="multipart/form-data">
            <div class="form-row">
              <div class="form-group col">
                ...
                <input type="text" class="form-control" id="truyen_ma" name="truyen_ma" placeholder="Mã truyện tranh" 
                  value="<?= $truyenRow['truyen_ma'] ?>">
              </div>
              <div class="form-group col">
                <label for="truyen_ten">Tên truyện tranh</label>
                <input type="text" class="form-control" id="truyen_ten" name="truyen_ten" placeholder="Tên truyện tranh" 
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="truyen_loai" name="truyen_loai" placeholder="Loại truyện tranh" value="#1-Tiểu thuyết" readonly>
              </div>
              <div class="form-group col">
            ...
            <div class="form-row">
              <div class="form-group col">
                ...
                <div class="preview-img-container text-center">
                  <img src="/project-nentang/assets/uploads/tieu-thuyet/<?= $truyenRow['truyen_hinhdaidien'] ?>" id="preview-img" width="200px" />
                </div>
              ...
              <div class="form-group col">
                ...
                <textarea class="form-control" id="truyen_mota_ngan" name="truyen_mota_ngan" placeholder="Mô tả ngắn về truyện tranh" rows="10"><?= $truyenRow['truyen_mota_ngan'] ?></textarea>
              </div>
            </div>
