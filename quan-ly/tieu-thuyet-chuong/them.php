...
<body class="d-flex flex-column h-100">
  ...
  <main role="main" class="mb-2">
    ...
    <div class="container mt-2">
      ...
      <h1 class="tieu-de">Quản lý Thêm mới Chương Tiểu thuyết</h1>
    </div>
          ...
          <form name="frmThemMoi" id="frmThemMoi" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="form-group col-3">
                ...
                <input type="number" class="form-control" id="chuong_so" name="chuong_so" placeholder="Số chương" value="">
              </div>
              <div class="form-group col-9">
                <label for="chuong_ten">Tên chương truyện tranh</label>
                <input type="text" class="form-control" id="chuong_ten" name="chuong_ten" placeholder="Tên chương truyện tranh" value="">
              </div>
            </div>
            <div class="form-row">
              <div class="col">
