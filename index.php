          ...
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  <?= substr($truyentranh['truyen_mota_ngan'], 0, min(strlen($truyentranh['truyen_mota_ngan']), 120)); ?>
                </p>
                <a href="truyen-tranh/chi-tiet.php?truyen_id=<?= $truyentranh['truyen_id'] ?>" class="btn btn-primary">Đọc Truyện</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
          ...
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="tieu-thuyet/chi-tiet.php?truyen_id=<?= $tieuthuyet['truyen_id'] ?>" class="btn btn-primary">Đọc Truyện</a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
